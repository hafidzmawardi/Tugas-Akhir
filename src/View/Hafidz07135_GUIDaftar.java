...
import javax.swing.*;
public class Hafidz07135_GUIDaftar {
    JFrame logReg = new JFrame();
    JLabel top, daftarr, id, nama, notelp, umur, password;
    JTextField textidDaftar, textnamaDaftar, textnotelpDaftar, textumurDaftar, textpasswordDaftar;
    JLabel idLogin, passwordLogin;
    JButton daftar, back;
    public Hafidz07135_GUIDaftar(){
    ...
    daftarr.setBounds(250, 30, 300, 100);
    ...
    daftar.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent ae){
                try{
                    ...
                    kosong();
                    Hafidz07135_GUILogin logingui = new Hafidz07135_GUILogin();
                    logReg.dispose();
